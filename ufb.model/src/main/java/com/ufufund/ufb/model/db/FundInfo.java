...
public class FundInfo implements Serializable {
	...
	public String toString() {
		return "FundInfo [fundcorpno=" + fundcorpno + ", fundcode=" + fundcode
				+ ", fundname=" + fundname + ", status=" + status
				+ ", fundtype=" + fundtype + ", fundvol=" + fundvol
				+ ", fundsize=" + fundsize + ", date=" + date + ", nav=" + nav
				+ ", navadditive=" + navadditive + ", income=" + income
				+ ", yield=" + yield + ", iscontract=" + iscontract
				+ ", dividmethod=" + dividmethod + ", shareclass=" + shareclass
				+ "]";
	}
