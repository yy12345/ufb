...
支付状态	payState	char(1)	R	1-支付成功，0-支付失败
基金公司订单申请单据流水号	appSheetSerialNo	char (24)	R	在认申购申请接口中返回
支付完成时间	paidTime	char (14)	R	直销平台订单实际支付时间格式为：YYYYMMDDHHmmSS
